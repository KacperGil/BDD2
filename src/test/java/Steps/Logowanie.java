...
public class Logowanie {
    ...
    public void uzytkownik_wpisuje_poprawne_haslo() {
        ...
        WebElement usernameInput=driver.findElement(By.name("password"));
        usernameInput.clear();
        usernameInput.sendKeys("SuperSecretPassword!");
    }
    ...
    public void uzytkownik_wpisuje_login(String login) {
        System.out.println("Krok 3 - Uzytkownik wpisuje poprawny login");
